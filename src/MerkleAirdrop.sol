...
contract MerkleAirdrop is EIP712 {
    ...
    //Why can't mappings be used in place of a merkle tree?
        ...
        public
    {
        ...
        if (!_isSignatureValid(account, getMessage(account, amount), v, r, s)) {
    ...
    function _isSignatureValid(address account, bytes32 digest, uint8 v, bytes32 r, bytes32 s)
        internal
        pure
        returns (bool)
    {
